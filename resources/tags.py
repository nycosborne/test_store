...
from db import db
from schemas import TagSchema, StoreSchema, ItemSchema
from models import TagModel, StoreModel, ItemModel

blp = Blueprint("Tags", "tags", __name__, description="Operations on items")
...
class TagsInStore(MethodView):
    ...
    def post(self, tag_date, store_id):
        tag = TagModel(**tag_date, store_id=store_id)
...
class LinkTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, messgae="Some thing not good happened")
...
class Tags(MethodView):
    @blp.response(200, TagSchema)
    def get(self, tag_id):
        tags = TagModel.query.get_or_404(tag_id)
        return tags
